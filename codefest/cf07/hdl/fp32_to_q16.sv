...
//   Implements Round-to-Nearest-Even (RNE) and Flush-To-Zero (FTZ) for subnormals.
// =========================================================================
...
module fp32_to_q16 (
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            automatic logic signed [8:0] raw_shift = 9'sd142 - {1'b0, s1_exp};
    ...
    always_ff @(posedge clk) begin
        if (rst) begin
            ...
            automatic logic [63:0] shift_in  = {s2_norm_mag, 32'b0};
            automatic logic [63:0] shift_out = shift_in >> s2_shift;
